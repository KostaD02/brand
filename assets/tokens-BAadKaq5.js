import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./react-Bl2r1tuC.js";import{a as r}from"./chunk-W22LQPXL-EGASGoRO.js";import{n as i,o as a,s as o}from"./blocks-Df-9ZqMx.js";import{n as s,t as c}from"./kostad-brand-tokens-C14wcNLY.js";import{a as l,c as u,i as d,n as f,o as p,r as m,s as h,t as g}from"./tokens.stories-BhwTuMbg.js";function _(e){let n={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,...t(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(a,{of:u}),`
`,`
`,`
`,`
`,`
...
`,(0,y.jsx)(T,{names:E(/^(selection|scrollbar|code-(bg|fg|inline-fg)$)/)}),`
`,(0,y.jsx)(n.h2,{id:`syntax-roles`,children:`Syntax roles`}),`
`,(0,y.jsxs)(n.p,{children:[`The colours of highlighted code are theme roles, set next to `,(0,y.jsx)(n.code,{children:`code-bg`}),` and `,(0,y.jsx)(n.code,{children:`code-fg`}),`. Most
colours picked for the dark navy block are too pale for light mode's white one, so each
theme sets its own value for every role except `,(0,y.jsx)(n.code,{children:`code-comment`}),`, which is `,(0,y.jsx)(n.code,{children:`#637777`}),` in both.`]}),`
`,(0,y.jsxs)(n.p,{children:[`There are thirteen, grouped the way VS Code's Dark+ theme groups tokens. Plain code takes
`,(0,y.jsx)(n.code,{children:`code-fg`}),` from the table above. `,(0,y.jsx)(n.a,{href:`?path=/docs/elements-syntax--docs`,children:`Syntax`}),` maps the roles
onto the `,(0,y.jsx)(n.code,{children:`hljs-*`}),` classes. Repoint one in a theme and every code block in that theme
follows; the two roles in the note below change nothing on the page.`]}),`
`,(0,y.jsx)(T,{names:E(/^code-(?!(bg|fg|inline-fg)$)/)}),`
`,(0,y.jsxs)(n.blockquote,{children:[`
`,(0,y.jsxs)(n.p,{children:[(0,y.jsx)(n.code,{children:`code-control`}),` and `,(0,y.jsx)(n.code,{children:`code-invalid`}),` exist for editor themes only, and no `,(0,y.jsx)(n.code,{children:`hljs-*`}),` rule
reads either. highlight.js gives every keyword the same class, so `,(0,y.jsx)(n.code,{children:`return`}),` and `,(0,y.jsx)(n.code,{children:`const`}),`
both take `,(0,y.jsx)(n.code,{children:`code-storage`}),`; it has no class for invalid code at all.`]}),`
`]}),`
...
are built from these, except most syntax roles, which use colours of their own. Each
palette colour also has an `,(0,y.jsx)(n.code,{children:`-rgb`}),` triplet for use inside `,(0,y.jsx)(n.code,{children:`rgb()`}),`.`]}),`
`,(0,y.jsx)(i,{of:g}),`
