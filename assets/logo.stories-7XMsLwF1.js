...
`},u={args:{initial:`K`,width:`45px`,bar:`4px`,color:`#64ffda`},argTypes:{initial:{control:`text`},width:{control:`text`},bar:{control:`text`},color:{control:`color`}},render:({initial:e,width:t,bar:n,color:r})=>i(`--kd-logo-width: ${t}; --kd-logo-bar: ${n}; --kd-logo-color: ${r};`,e)},d=[`Example`,`Sizes`,`Colour`,`AsLink`,`Logo`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => logo("")
...
}`,...u.parameters?.docs?.source}}}})))()}export{f as a,s as i,c as n,n as o,o as r,l as t};