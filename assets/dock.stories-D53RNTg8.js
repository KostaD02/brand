...
`)}},h=[`Example`,`Anchoring`,`Text`,`Flow`,`FlowAtBreakpoint`,`Stacking`,`Dock`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => frame("17rem", \`
  <ul class="kd-dock kd-dock--start">
\${links}
...
}`,...m.parameters?.docs?.source}}}})))()}export{p as a,g as c,f as i,c as n,u as o,d as r,n as s,l as t};