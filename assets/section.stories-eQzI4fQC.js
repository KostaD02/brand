...
`)},l={args:{spacing:`default`},argTypes:{spacing:{control:`inline-radio`,options:[`default`,`tight`,`flush`]}},render:({spacing:e})=>{let t=[`kd-section`];return e!=="default"&&t.push(`kd-section--${e}`),a(`<section class="${t.join(` `)}">${i(t.map(e=>`.${e}`).join(` `))}</section>`)}},u=[`Example`,`Spacing`,`WithContainer`,`Section`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
...
}`,...l.parameters?.docs?.source}}}})))()}export{n as a,d as i,s as n,c as r,o as t};