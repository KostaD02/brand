import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{i as t,r as n}from"./react-Bl2r1tuC.js";import{a as r}from"./chunk-W22LQPXL-EGASGoRO.js";import{n as i,o as a,s as o}from"./blocks-BiI4XObh.js";import{a as s,c,i as l,n as u,o as d,r as f,s as p,t as m}from"./display.stories-DZykMvvy.js";function h(e){let n={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,strong:`strong`,...t(),...e.components};return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(a,{of:p}),`
...
`]}),`
`,(0,_.jsxs)(n.blockquote,{children:[`
`,(0,_.jsxs)(n.p,{children:[`Among the utilities only `,(0,_.jsx)(n.code,{children:`display`}),` and `,(0,_.jsx)(n.code,{children:`kd-gutter-*`}),` have responsive variants. The full
cross-product across every group would multiply the utilities bundle several times over,
so it is deliberate restraint rather than an omission.`]}),`
`]}),`
`,(0,_.jsxs)(n.blockquote,{children:[`
`,(0,_.jsxs)(n.p,{children:[`The display utilities are emitted last in the utility layer, so they beat any other
utility that also sets `,(0,_.jsx)(n.code,{children:`display`}),`, including `,(0,_.jsx)(n.code,{children:`kd-flex-center`}),` and `,(0,_.jsx)(n.code,{children:`kd-grid-auto`}),`.`]}),`
`]}),`
