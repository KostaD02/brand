...
`)},f=[`Example`,`Hover`,`FitsContent`,`Tint`,`Frame`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
...
\`)
}`,...d.parameters?.docs?.source}}}})))()}export{n as a,u as i,l as n,p as o,c as r,s as t};