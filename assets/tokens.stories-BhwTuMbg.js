...
</div>`).join(``)},f=[`Palette`,`Spacing`,`SpacingLarge`,`Radius`,`Shadow`,`TypeScale`],a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<div class="kd-d-grid kd-gap-2" style="grid-template-columns: repeat(auto-fill, minmax(9rem, 1fr));">
...
}`,...d.parameters?.docs?.source}}}})))()}export{c as a,n as c,s as i,l as n,d as o,u as r,p as s,a as t};