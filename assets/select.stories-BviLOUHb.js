...
`,o={tags:[`!dev`],render:()=>a(`region`,`Region`,`<select class="kd-field__input" id="region">${i}</select>`)},s={tags:[`!dev`],render:()=>a(`region-empty`,`Region`,`<select class="kd-field__input" id="region-empty">
    ...
    <option value="" disabled selected>Choose a region</option>
    ${i}
  </select>`,`<span class="kd-field__error" id="region-error">Pick a region to continue.</span>`)},u={tags:[`!dev`],render:()=>a(`region-off`,`Disabled`,`<select class="kd-field__input" id="region-off" disabled>${i}</select>`)},d={args:{state:`default`,disabled:!1},argTypes:{state:{control:`inline-radio`,options:[`default`,`valid`,`invalid`]},disabled:{control:`boolean`}},render:({state:e,disabled:t})=>{let n=[`kd-field__input`];return e!=="default"&&n.push(`kd-${e}`),a(`playground`,`Label`,`<select class="${n.join(` `)}" id="playground"${e===`invalid`?` aria-invalid="true"`:``}${t?` disabled`:``}>${i}</select>`)}},f=[`Example`,`Placeholder`,`Grouped`,`Validation`,`Disabled`,`Select`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
...
}`,...d.parameters?.docs?.source}}}})))()}export{l as a,s as i,o as n,p as o,c as r,n as s,u as t};