...
`)}},m=[`Example`,`Collapse`,`Breakpoints`,`Ratios`,`Align`,`Reverse`,`Split`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => frame(\`
<div class="kd-split">
  \${box("content")}
...
}`,...p.parameters?.docs?.source}}}})))()}export{u as a,n as c,s as i,l as n,f as o,c as r,h as s,d as t};