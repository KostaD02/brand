...
`}},f=[`Variations`,`Outline`,`Sizes`,`Block`,`Icon`,`Disabled`,`Anatomy`,`Button`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<div class="kd-d-flex kd-gap-2 kd-flex-wrap">
  <button type="button" class="kd-btn kd-btn--primary">Primary</button>
...
}`,...d.parameters?.docs?.source}}}})))()}export{a,n as c,c as i,p as l,s as n,o,l as r,i as s,u as t};