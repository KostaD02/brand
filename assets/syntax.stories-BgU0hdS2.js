import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";var n=t({Css:()=>f,Diff:()=>v,Dockerfile:()=>g,Example:()=>c,JavaScript:()=>d,Json:()=>p,Markdown:()=>_,Markup:()=>u,Retint:()=>y,Shell:()=>h,Stylesheet:()=>l,Syntax:()=>b,Yaml:()=>m,__namedExportsOrder:()=>x,default:()=>s}),r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;function S(){return(S=e((()=>{r=[`typescript`,`javascript`,`html`,`css`,`scss`,`json`,`yaml`,`bash`,`dockerfile`,`markdown`,`diff`],i=[`comment`,`storage`,`control`,`function`,`type`,`variable`,`constant`,`string`,`number`,`regexp`,`escape`,`punctuation`,`invalid`],a={typescript:`<span class="hljs-comment">// theme.ts</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">article</span>&gt;</span>`,css:`<span class="hljs-comment">/* tokens.css */</span>
...
<span class="hljs-punctuation">}</span>`,yaml:`<span class="hljs-comment"># .github/workflows/ci.yml</span>
    ...
    <span class="hljs-attr">steps:</span>
      ...
      <span class="hljs-bullet">-</span> <span class="hljs-attr">run:</span> <span class="hljs-string">pnpm</span> <span class="hljs-string">run</span> <span class="hljs-string">build</span>
        <span class="hljs-attr">env:</span>
          ...
          <span class="hljs-attr">CI:</span> <span class="hljs-literal">true</span>`,bash:`<span class="hljs-meta">#!/usr/bin/env bash</span>
...
pnpm run build &amp;&amp; pnpm run lint`,dockerfile:`<span class="hljs-keyword">FROM</span> node:<span class="hljs-number">24</span>-alpine AS build
...
<span class="hljs-keyword">EXPOSE</span> <span class="hljs-number">80</span>`,markdown:`<span class="hljs-section"># @kostad/brand</span>
...
[<span class="hljs-string">Storybook</span>](<span class="hljs-link">https://kostad02.github.io/brand</span>)`,diff:`<span class="hljs-comment">diff --git a/scss/variables/_global.scss b/scss/variables/_global.scss</span>
...
<span class="hljs-addition">+  code-comment: #637777,</span>`},o=(e,t)=>`
<pre${t?` style="${t}"`:``}><code class="hljs language-${e}">${a[e]}</code></pre>
`,s={title:`Elements/Syntax`,parameters:{layout:`padded`}},c={tags:[`!dev`],render:()=>o(`typescript`)},l={tags:[`!dev`],render:()=>o(`scss`)},u={tags:[`!dev`],render:()=>o(`html`)},d={tags:[`!dev`],render:()=>o(`javascript`)},f={tags:[`!dev`],render:()=>o(`css`)},p={tags:[`!dev`],render:()=>o(`json`)},m={tags:[`!dev`],render:()=>o(`yaml`)},h={tags:[`!dev`],render:()=>o(`bash`)},g={tags:[`!dev`],render:()=>o(`dockerfile`)},_={tags:[`!dev`],render:()=>o(`markdown`)},v={tags:[`!dev`],render:()=>o(`diff`)},y={tags:[`!dev`],render:()=>o(`typescript`,`--kd-code-storage: #0dff009d; --kd-code-string: #9ee7ff;`)},b={args:{language:`typescript`,role:`storage`,color:`#0dff009d`},argTypes:{language:{control:`select`,options:r},role:{control:`select`,options:i},color:{control:`color`}},render:({language:e,role:t,color:n})=>o(e,`--kd-code-${t}: ${n};`)},x=[`Example`,`Stylesheet`,`Markup`,`JavaScript`,`Css`,`Json`,`Yaml`,`Shell`,`Dockerfile`,`Markdown`,`Diff`,`Retint`,`Syntax`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  ...
  tags: ["!dev"],
  render: () => block("typescript", "--kd-code-storage: #0dff009d; --kd-code-string: #9ee7ff;")
  ...
  render: ({
    ...
    role,
    color
  }) => block(language, \`--kd-code-\${role}: \${color};\`)
}`,...b.parameters?.docs?.source}}}})))()}export{d as a,u as c,l as d,m as f,c as i,y as l,n as m,v as n,p as o,S as p,g as r,_ as s,f as t,h as u};