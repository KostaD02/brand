...
<span
  ...
  aria-label="Loading"
></span>
`}},l=[`Example`,`Sizes`,`Danger`,`InButton`,`Spinner`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<span class="kd-spinner" role="status" aria-label="Loading"></span>
\`
...
}`,...c.parameters?.docs?.source}}}})))()}export{u as a,a as i,i as n,n as o,s as r,o as t};