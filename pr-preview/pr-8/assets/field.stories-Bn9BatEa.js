...
`},u=[`Example`,`Hint`,`Error`,`WithIcon`,`Spacing`,`Field`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<div class="kd-field" style="max-width: 24rem;">
  <label class="kd-field__label" for="account">Account name</label>
...
\`
}`,...l.parameters?.docs?.source}}}})))()}export{s as a,c as i,i as n,n as o,a as r,d as s,o as t};