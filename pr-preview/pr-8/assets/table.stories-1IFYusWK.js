...
`}},_=[`Example`,`Caption`,`Scroll`,`StickyHead`,`Plain`,`Rows`,`Archive`,`Table`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<table>
  <thead>
...
}`,...g.parameters?.docs?.source}}}})))()}export{m as a,v as c,p as i,n as l,u as n,d as o,l as r,f as s,h as t};