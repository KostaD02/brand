...
`},l=[`Example`,`Checked`,`Disabled`,`WithoutLabel`,`Toggle`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<label class="kd-toggle">
  <input class="kd-toggle__input" type="checkbox" />
...
\`
}`,...c.parameters?.docs?.source}}}})))()}export{u as a,s as i,o as n,n as o,i as r,a as t};