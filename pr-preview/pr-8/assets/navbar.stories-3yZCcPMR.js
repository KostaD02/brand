...
`,r.map(e=>`.${e}`).join(` `))}},h=[`Example`,`Scrolled`,`Hidden`,`Bare`,`Responsive`,`ActiveLink`,`Navbar`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => frame(\`
<header class="kd-navbar" style="position: absolute;">
  \${brand}
...
}`,...m.parameters?.docs?.source}}}})))()}export{f as a,n as c,u as i,d as n,l as o,c as r,g as s,p as t};