...
`}},d=[`Example`,`Anchor`,`Active`,`Skip`,`SkipInline`,`Link`],a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<p>
  Every bare <a href="#">anchor</a> already carries the underline treatment, so
...
}`,...u.parameters?.docs?.source}}}})))()}export{l as a,c as i,o as n,f as o,a as r,n as s,s as t};