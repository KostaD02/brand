...
`},s=[`Example`,`WithDot`,`StatusPill`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<span class="kd-status-pill">Idle</span>
<span class="kd-status-pill kd-status-pill--active">Running</span>
...
\`
}`,...o.parameters?.docs?.source}}}})))()}export{n as i,a as n,c as r,i as t};