import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";var n=t({HeaderAnchor:()=>p,Headings:()=>i,List:()=>u,ListColumns:()=>d,ListPlain:()=>f,Mono:()=>l,Paragraph:()=>a,SectionHeading:()=>o,SectionHeadingCustom:()=>c,SectionHeadingVariations:()=>s,__namedExportsOrder:()=>m,default:()=>r}),r,i,a,o,s,c,l,u,d,f,p,m;function h(){return(h=e((()=>{r={title:`Elements/Typography`,parameters:{layout:`padded`}},i={tags:[`!dev`],render:()=>`
...
`},m=[`Headings`,`Paragraph`,`SectionHeading`,`SectionHeadingVariations`,`SectionHeadingCustom`,`Mono`,`List`,`ListColumns`,`ListPlain`,`HeaderAnchor`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<h1>Heading level 1</h1>
<h2>Heading level 2</h2>
...
<h3><a class="kd-header-anchor" href="#section">Linkable section heading</a></h3>
\`
}`,...p.parameters?.docs?.source}}}})))()}export{f as a,o as c,h as d,n as f,d as i,c as l,i as n,l as o,u as r,a as s,p as t,s as u};