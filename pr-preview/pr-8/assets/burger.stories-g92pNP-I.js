...
`},c=[`Example`,`Open`,`InNavbar`,`Burger`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<button type="button" class="kd-burger" aria-expanded="false" aria-label="Menu">
  <span class="kd-burger__bar"></span>
...
\`
}`,...s.parameters?.docs?.source}}}})))()}export{l as a,n as i,o as n,a as r,i as t};