...
`)}},u=[`Example`,`Menu`,`Closing`,`Drawer`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => frame(\`
  <div class="kd-drawer" style="position: absolute;">
    <ul class="kd-drawer__panel">
...
}`,...l.parameters?.docs?.source}}}})))()}export{d as a,n as i,o as n,s as r,c as t};