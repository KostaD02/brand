...
`}},h=[`Blockquote`,`Rule`,`InlineCode`,`CodeBlock`,`Figure`,`Prose`,`ProseRhythm`,`ProseLists`,`ProseOverflow`,`Content`],a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<blockquote>
  Design systems are not about the components. They are about the decisions the
...
}`,...m.parameters?.docs?.source}}}})))()}export{u as a,d as c,g as d,s as i,o as l,c as n,f as o,l as r,p as s,a as t,n as u};