...
`},u={args:{property:`w`,value:`50`},argTypes:{property:{control:`inline-radio`,options:[`w`,`min-w`,`max-w`,`h`]},value:{control:`inline-radio`,options:[`0`,`25`,`50`,`75`,`100`]}},render:({property:e,value:t})=>i(`kd-${e}-${t}`,`.kd-${e}-${t}`)},d=[`Width`,`Keywords`,`Height`,`ViewportHeight`,`Sizing`],o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:'{\n  tags: ["!dev"],\n  render: () => ["25", "50", "75", "100"].map(value => bar(`kd-w-${value}`, `.kd-w-${value}`)).join("")\n}',...o.parameters?.docs?.source}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:'{\n  tags: ["!dev"],\n  render: () => ["w-auto", "w-fit", "w-full"].map(name => bar(`kd-${name}`, `.kd-${name}`)).join("")\n}',...s.parameters?.docs?.source}}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  tags: ["!dev"],
  render: () => \`
<div class="kd-d-flex kd-gap-2" style="height: 8rem;">
  <div class="kd-h-25" style="padding: var(--kd-space-1); background: var(--kd-accent-soft); border: 1px solid var(--kd-accent-line); font-family: var(--kd-font-mono); font-size: var(--kd-font-size-xxs);">.kd-h-25</div>
...
}`,...u.parameters?.docs?.source}}}})))()}export{f as a,o as i,s as n,n as o,l as r,c as t};